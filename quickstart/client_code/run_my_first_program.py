...
async def main():
    ...
    # Create a secret named "input1" with any value, ex: 500
    new_secret = nillion.NadaValues(
        {
            "input1": nillion.SecretInteger(500),
        }
    )

    # Set the input party for the secret
    # The party name needs to match the party name that is storing "input1" in the program
    party_name = "Party1"
    ...
    # Add input2, the 2nd secret at computation time
    computation_time_secrets = nillion.NadaValues({"input2": nillion.SecretInteger(10)})
